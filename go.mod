...
replace (
	// these replacements are pinned to a commit which is the sha associated with the 1.21.0 tag on k/k
	// as you cannot pin them to v1.21.0 directly
	...
	k8s.io/sample-cli-plugin => k8s.io/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20210408162405-cb303e613a12
	k8s.io/sample-controller => k8s.io/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20210408162405-cb303e613a12
)
