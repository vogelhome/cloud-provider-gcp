...
replace (
	// these replacements are pinned to a commit which is the sha associated with the 1.25.0 tag on k/k
	// as you cannot pin them to v1.25.0 directly
	...
	k8s.io/sample-cli-plugin => k8s.io/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20220823173643-a866cbe2e5bb
	k8s.io/sample-controller => k8s.io/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20220823173643-a866cbe2e5bb
)
